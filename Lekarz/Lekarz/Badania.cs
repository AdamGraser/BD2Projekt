...
namespace Lekarz {
    ...
    public class Badania : ReportClass {
    ...
    public class CachedBadania : Component, ICachedReport {
        
        public CachedBadania() {
        }
